...
function swingRight() {
  if (isVisible(svg)) {
    ...
    setTimeout(function() {
      n6.animate({
        d: "M4748 658c115 0 207 48 265 117 80 95 80 206 80 284v697h-50v-697c0-75 0-169-68-249-51-60-134-102-237-102s-186 42-237 102c-68 80-68 174-68 249v697h-50V674h50v165c53-115 169-181 315-181z"
      }, duration, easing);
    }, delay * 5);
    setTimeout(function() {
      w7.animate({
...
function swingLeft() {
  if (isVisible(svg)) {
    ...
    setTimeout(function() {
      n6.animate({
        d: "M5104 658c122 0 221 55 282 132 83 104 83 232 83 321v645h-150v-645c0-97 0-171-58-239-40-47-105-80-187-80s-147 33-187 80c-58 68-58 142-58 239v645h-150V674h150v114c72-79 156-130 275-130z"
      }, duration, easing);
    }, delay * 4);
    setTimeout(function() {
      e5.animate({
...
// We need a small delay so that isVisible returns correct value
