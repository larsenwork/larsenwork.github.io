<template>
  <div class="c-social">
    <a
        class="c-social-link"
        href="http://github.com/larsenwork/">
      <svg viewBox="0 0 800 800" class="c-social-icon">
        <title>Larsenwork on github</title>
    ...
    <a
        class="c-social-link"
        href="http://codepen.com/larsenwork/">
      <svg viewBox="0 0 800 800" class="c-social-icon">
        <title>Larsenwork on codepen</title>
        <path d="M140 482V320q0-10 10-18l238-158q12-8 24 0l238 158q9 6 10 19v158q0 10-10 19L412 656q-12 8-24 0L150 497q-9-6-10-15zm282-278v104l97 65 78-52zm-44 104V204L203 321l78 52zm-193 54v75l56-37zm193 234V492l-97-65-78 52zm22-143l79-53-79-53-79 53zm22 143l175-117-78-52-97 64v105zm193-159v-75l-56 38z"></path>
      </svg>
    </a>
    <a
        class="c-social-link"
        href="https://medium.com/@larsenwork">
      <svg viewBox="0 0 800 800" class="c-social-icon">
        <title>Larsenwork on Medium</title>
        <path d="M190.7 274c.7-6.6-1.8-13-6.7-17.5L133.8 196v-9h155.8L410 451.1 516 187h148.5v9l-42.9 41.2a12.5 12.5 0 0 0-4.7 12v302.3c-.8 4.5 1 9.2 4.7 12l42 41.1v9H452.6v-9l43.4-42.1c4.2-4.3 4.2-5.5 4.2-12V306L379.7 612.7h-16.3L222.8 306v205.5a28.3 28.3 0 0 0 7.8 23.6l56.5 68.4v9H127v-9l56.5-68.4c6-6.3 8.7-15 7.2-23.6V274z"/>
      </svg>
    </a>
    <a
        class="c-social-link"
        href="https://dribbble.com/larsenwork">
      <svg viewBox="0 0 800 800" class="c-social-icon">
        <title>Larsenwork on Dribbble</title>
    ...
    <a
        class="c-social-link"
        href="http://twitter.com/larsenwork/">
      <svg viewBox="0 0 800 800" class="c-social-icon">
        <title>Follow larsenwork on twitter</title>
