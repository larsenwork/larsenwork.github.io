  ...
  <nav
    ...
    <div class="c-navigation-links u-lineLength u-grid">
      <div class="c-navigation-links-column">
        <h3 class="c-navigation-links-header">Me</h3>
        <nuxt-link
      ...
      <div class="c-navigation-links-column">
        <h3 class="c-navigation-links-header">Tools</h3>
        <nuxt-link
            class="c-navigation-link"
            @click.native="hideNavigation"
            to="/easing-gradients">
      ...
      <div class="c-navigation-links-column">
        <h3 class="c-navigation-links-header">Ramblings</h3>
        <div
            class="c-navigation-link c-navigation-link--wip"
            >
          Blog
      ...
      <div class="c-navigation-links-donate">
        <h3 class="c-navigation-links-header">Pay it forward</h3>
        <a
